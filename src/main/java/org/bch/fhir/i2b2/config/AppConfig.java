...
public class AppConfig {
    ...
    /**
     * Get the i2b2 mappings for Observation fhir resources. See file observationCodes.c3pro under
     * org/bch/fhir/i2b2/services
     * @return The mapping
     */
    ...
    /**
     * Get the mapping types for Observation fhir resources. See file observationCodesType.c3pro under
     * org/bch/fhir/i2b2/services
     * @return The mapping
     */
    ...
    private static Map<String, String> getRealConceptCodesMapGeneric(String file, Map<String, String> out) {
        if (out.isEmpty()) {
            ...
            try {
                Utils.textFileToStringBuffer(FHIRToPDO.class, file, sb, ",");
            } catch (Exception e) {
                return out;
            }
    ...
    /**
     * Get the i2b2 mappings for QuestionnaireResponse fhir resources. See file conceptCodes.c3pro under
     * org/bch/fhir/i2b2/services
     * @return The mapping
     */
    ...
    /**
     * Get the mapping types for QuestionnaireResponse fhir resources. See file conceptCodesType.c3pro under
     * org/bch/fhir/i2b2/services
     * @return The mapping
     */
     ...
     * @throws FHIRI2B2Exception If the property key does not exist.
     */
     ...
     * @throws FHIRI2B2Exception In case the parameter is not well-formed
     */
