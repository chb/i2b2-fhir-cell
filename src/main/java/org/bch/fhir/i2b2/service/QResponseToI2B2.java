...
/**
 * Generates the i2b2 pdo xml equivalent for fhir QuestionnaireResponse resource
 * @author CHIP-IHL
 */
public class QResponseToI2B2 extends FHIRToPDO {
     ...
     * @param resource  The fhir resource. It must be a QuestionnaireResponse resource
     * @return  The pdo xml as String
     * @throws FHIRI2B2Exception In case Encounter reference is not found in the contained resources
     */
    @Override
